...
export const metadata: Metadata = {
  title: "Terms & Conditions — Nudge",
  description:
    "The terms governing your use of Nudge, the SMS-based subscription trial reminder service.",
};

// Text preserved from the previously TermsFeed-hosted document so the
        ...
        <div className="space-y-8 text-[14.5px] leading-[1.7] text-[rgba(27,27,24,0.85)]">
          ...
          <Section title="Interpretation and Definitions">
            ...
            <ul className="list-disc pl-5 space-y-1.5 mt-3">
              ...
              <li>
                <span className="font-medium">Terms and Conditions</span> (also
                referred to as &quot;Terms&quot;) means these Terms and
                ...
                the Service. These Terms and Conditions have been created with
                the help of the{" "}
                <a
              ...
              <li>
                <span className="font-medium">Website</span> refers to Nudge.
              </li>
              <li>
          ...
          <Section title="Links to Other Websites">
            ...
            <p>
              ...
              content or services provided by a Third-Party Social Media Service.
              A Third-Party Social Media Service is not owned or controlled by
              the Company, and the Company does not endorse or assume
          ...
          <Section title="Severability and Waiver">
            <p className="font-medium">Severability</p>
            <p>
            ...
            <p className="font-medium mt-4">Waiver</p>
            <p>
